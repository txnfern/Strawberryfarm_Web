...
function Products() {
  ...
  // ฟังก์ชันสำหรับไปหน้า Cart เมื่อกด Add to Cart
  const handleAddToCart = (item) => {
    // ส่งข้อมูลสินค้าไปด้วย (ถ้าต้องการ)
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="bg-gradient-to-r from-pink-500 to-red-500 text-white px-4 py-2 rounded-lg hover:from-pink-600 hover:to-red-600 transition-all duration-300 flex items-center gap-2 transform hover:scale-105"
                  >
